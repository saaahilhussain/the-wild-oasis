...
export const bookings = [
  ...
  // Additional recent bookings for last 7 days data
  {
    created_at: fromToday(-1, true),
  ...
  // Additional bookings for today's activity
  {
    created_at: fromToday(-3, true),
    startDate: fromToday(0),
    endDate: fromToday(2),
